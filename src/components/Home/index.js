...
import HomeStatesList from '../HomeStatesList'
...
class Home extends Component {
  ...
  render() {
    ...
    const filteredStatesList = statesList.filter(eachState =>
      eachState.state_name.toLowerCase().includes(name.toLowerCase()),
    )
    return (
      <div className="home">
          ...
          filteredStatesList.map(eachState => (
            <Link to={`/state/:${eachState.state_code}`}>
              <div className="search-state-item">
                ...
                <div className="search-state-code-div">
                  <p className="search-state-code">{eachState.state_code}</p>
                  <BiChevronRightSquare className="search-state-go" />
                </div>
              </div>
            </Link>
          ))}
